  ...
  return (
    <div>
      <Parallax small filter image={require("assets/img/banner.jpg")}>
        ...
        <h1 className={classes.title + " aboutMeTitle"}>A little bit about me...</h1>
      </Parallax>
              ...
              <GridItem xs={12} sm={12} md={12}>
                <div className={classes.profile + " aboutMeTextContainer"}>
                  ...
                  <div className={classes.name}>
                    ...
                    <h3 className="strapline ">Who am I?</h3>
                    
                    <p>Well, by day I make pots, by night, I am a caped crusader, cruising the streets for Crims.</p>
              ...
              <GridItem xs={12} sm={12} md={12}>
                <div className={classes.profile + " aboutMeTextContainer"}>                 
                  ...
                  <div className={classes.name}>
                    ...
                    <h3 className="strapline ">Why do I do it?</h3>
                    
                    <p>Justice is most important to me. Crime doesn't take a break so neither do I.</p>
